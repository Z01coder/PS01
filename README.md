...
Этот репозиторий содержит HTML код простого сайта с одной страницей. Сайт предоставляет краткую информацию о популярном китайском научно-фантастическом романе "Задача трёх тел".
